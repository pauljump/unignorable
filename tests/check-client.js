...
if (!html.includes("function webMcpFeatureById(conditionId){return webMcpFeatures().find(feature=>String(feature.id)===String(conditionId)||(feature.id_aliases||[]).some")) throw new Error('WebMCP must resolve retained reported-coordinate aliases to the canonical condition');
