...
test('seeded community submissions cannot change generated condition, nowcast, or routing fields', () => {
  ...
  source.exec(`CREATE TABLE sr311(
    ...
    resolution_description TEXT, resolution_action_updated_date TEXT, incident_address TEXT,
    cross_street_1 TEXT, cross_street_2 TEXT, borough TEXT,
  ...
  for (let day = 11; day <= 19; day += 1) {
    insert.run(String(day), 'Encampment', `2026-08-${day}T07:30:00.000`, null, 'NYPD', 'Closed',
      ...
      day === 19 ? '2026-08-19T09:00:00.000' : null, '100 WEST 23 STREET', '6 AVENUE', '7 AVENUE',
      'MANHATTAN', 40.746, -73.987);
  }
  source.close();
